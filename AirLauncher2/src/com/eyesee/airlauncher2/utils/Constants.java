...
public interface Constants {
	...
	public static final String BTCALL_PACKAGE_NAME = "com.example.carairbluetooth2";
	public static final String AIRSETTING_PACKAGE_NAME = "com.eyesee.CarAirSetting2";
	public static final String FILEMANAGER_PACKAGE_NAME = "com.estrongs.android.pop";//es文件浏览器
	public static final String NAV_PACKAGE_NAME = "com.baidu.BaiduMap";//百度地图
	public static final String RECODER_PACKAGE_NAME = "com.aw.recorder";
